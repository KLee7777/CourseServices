...
public class Main
{
    ...
    {   //TODO Loop through the student enrolled courses, and use the scanner object to get the course ID to insert
        ...
        HashMap<String, EnrolledCourse> enrolledCoursesId = student.getEnrolledCourses();
        for (String course : enrolledCoursesId.keySet()) {
            System.out.println(course);
        }
        ...
        System.out.println("Enter grade for " + courseCode + ":");
        double grade = scanner.nextDouble();
        student.gradeCourse(courseCode, grade);

        System.out.println("Grade recorded for course " + courseCode + ".");
    }
    ...
    private static void showPassedCourses(StudentService studentService, Scanner scanner )
    {
        ...
        HashMap<String, EnrolledCourse> coursesPassed = studentService.getPassedCourses(student);
        for (String courseCode : coursesPassed.keySet()) {
